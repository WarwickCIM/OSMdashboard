...
hist_map_changesets <- contributions_summary |>
  ...
  # scale_x_continuous(breaks = seq(0, 20, by = 5)) +
  labs(y = "Number of users", x = "Changesets authored by user") +
  theme_user_stats
...
hist_diary <- contributions_summary |>
  ...
  # scale_x_continuous(breaks = seq(0, 20, by = 5)) +
  labs(y = "Number of users", x = "Diary entries authored by user") +
  theme_user_stats
...
hist_traces <- contributions_summary |>
  ...
  # scale_x_continuous(breaks = seq(0, 20, by = 5)) +
  labs(y = "Number of users", x = "Traces uploaded by user") +
  theme_user_stats
