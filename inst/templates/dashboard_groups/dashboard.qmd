...
# make sure Python can see the local "python" folder
sys.path.insert(0, os.path.join(os.getcwd(), "python"))

# now safe to import your helper module
import overlay
...
# Quarto exposes YAML params as "params"
p = params if 'params' in globals() else {}

# read params with sane fallbacks
db_path = p.get("db_path") or os.getenv("DUCKDB_PATH", "../database/osm_changesets.duckdb")
